  ...
  <script>
    ...
    $(document).ready(function(){
      ...
      $("#btn-msg").click(function(){
        ...
        $("#loaded_msg").load("load-msg.php", {message: message});
      });
    });
...
<div class="row">
 ...
 $user_from_name = $row['user_name'];
    ...
    <div class="col-sm-3" id="selec_user"> 
    	<?php
    ...
    <div class="col-sm-6">
       ...
       <?php
          ...
          echo"<h4 style='color: red;text-align: center;'>Message is too long! use only 40 characters</h4>";
      }
...
<!--    <script>
    $('document').ready(function(){
        $('btn-msg').click(function(){
            var message = $('message_textarea').val();
            $('message_textarea').reset();
            $.post('messages.php',{message: message},function(response){
                $("loaded_msg").load("messages.php loaded_msg");
            });
        })
        ...
        function startTimer() {
          $("loaded_msg").load("messages.php loaded_msg", function(){
