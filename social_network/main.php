...
<html>
<head>
	<title>LinkZone login and signup</title>
	<meta charset="utf-8">
...
<body>
	<div class="row">
		<div class="col-sm-12">
			<div class="well">
				<center><h1 style="color: white;">LinkZone</h1></center>
			</div>
		</div>
	</div>
	<div class="row">
		...
		<div class="col-sm-6" style="left:8%:">
			<img src="images/link.jpg" class="img-rounded" title="Coding cafe" width="120px" height="120px">
			<h2><strong>See what's happening in <br> the world right now</strong></h2><br><br>
			<h4><strong>join LinkZone Today.</strong></h4>
